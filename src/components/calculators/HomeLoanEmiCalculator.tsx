...
const schema = z.object({
  principal: z
    ...
    .refine((val) => Number(val) > 0, { message: "Principal amount must be greater than 0" }),
  rate: z
    .string()
  ...
  return (
    <div className="max-w-2xl mx-auto my-4 animate-fade-in">
      <Card className="shadow-lg border-[#ffe066]">
        <CardHeader>
          ...
          <CardDescription className="mt-3 text-muted-foreground">
            Easily estimate monthly EMI, total payment, and total interest for your home loan.
          </CardDescription>
        </CardHeader>
      ...
      <div className="mt-8">
        <Accordion type="single" collapsible>
          ...
          <AccordionItem value="q2">
            ...
            <AccordionContent>
              The EMI uses the principal, annual interest rate, and loan tenure. The formula assumes a fixed (not reducing) balance interest.
            </AccordionContent>
          </AccordionItem>
      ...
      <div className="mt-6 p-4 bg-[#F4FFF9]/80 dark:bg-[#1e2e20]/80 rounded-md text-muted-foreground text-xs">
        <Info className="w-4 h-4 inline mb-1 text-[#00B86B]" /> This calculator provides quick estimates; actual EMI may differ as per bank policies.
      </div>
    </div>
  );
}
